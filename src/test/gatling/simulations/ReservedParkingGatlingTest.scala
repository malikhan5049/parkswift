...
/**
 * Performance test for the ReservedParking entity.
 */
class ReservedParkingGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ReservedParking entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all reservedParkings")
            .get("/api/reservedParkings")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created reservedParking")
                .get("${new_reservedParking_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created reservedParking")
            .delete("${new_reservedParking_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
