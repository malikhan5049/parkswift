...
import com.ews.parkswift.web.filter.CachingHttpHeadersFilter;
import com.ews.parkswift.web.filter.CustomReponseForMobileFilter;
import com.ews.parkswift.web.filter.StaticResourcesProductionFilter;
import com.ews.parkswift.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer,
	...
	public void onStartup(ServletContext servletContext)
		...
		initCustomResponseForMobileFilter(servletContext, disps);
	...
	private void initCustomResponseForMobileFilter(ServletContext servletContext,
			EnumSet<DispatcherType> disps) {
		log.debug("Registering Custom Response for Mobile Filter");
		FilterRegistration.Dynamic customResponseForMobileFilter = servletContext
				.addFilter("customResponseForMobileFilter",
						new CustomReponseForMobileFilter());

		customResponseForMobileFilter.addMappingForUrlPatterns(disps, true,
				"/api/*");
		customResponseForMobileFilter.setAsyncSupported(true);
	}
