...
import com.ews.parkswift.security.Http401UnauthorizedEntryPoint;
import com.ews.parkswift.security.xauth.TokenProvider;
import com.ews.parkswift.security.xauth.XAuthTokenConfigurer;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/authenticatemobile").permitAll()
